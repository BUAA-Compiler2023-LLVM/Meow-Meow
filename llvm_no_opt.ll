...
b1:
	%4 = load i32, i32* @cnt
	%5 = getelementptr [5005 x i32], [5005 x i32]* @to, i32 0, i32 %4
	%6 = load i32, i32* %3
	store i32 %6, i32* %5
	%7 = load i32, i32* @cnt
	%8 = getelementptr [5005 x i32], [5005 x i32]* @next, i32 0, i32 %7
	%9 = load i32, i32* %2
	%10 = getelementptr [1005 x i32], [1005 x i32]* @head, i32 0, i32 %9
	%11 = load i32, i32* %10
	store i32 %11, i32* %8
	%12 = load i32, i32* %2
	%13 = getelementptr [1005 x i32], [1005 x i32]* @head, i32 0, i32 %12
	%14 = load i32, i32* @cnt
	store i32 %14, i32* %13
	%15 = load i32, i32* @cnt
	%16 = add i32 %15, 1
	store i32 %16, i32* @cnt
	%17 = load i32, i32* @cnt
	%18 = getelementptr [5005 x i32], [5005 x i32]* @to, i32 0, i32 %17
	%19 = load i32, i32* %2
	store i32 %19, i32* %18
	%20 = load i32, i32* @cnt
	%21 = getelementptr [5005 x i32], [5005 x i32]* @next, i32 0, i32 %20
	%22 = load i32, i32* %3
	%23 = getelementptr [1005 x i32], [1005 x i32]* @head, i32 0, i32 %22
	%24 = load i32, i32* %23
	store i32 %24, i32* %21
	%25 = load i32, i32* %3
	%26 = getelementptr [1005 x i32], [1005 x i32]* @head, i32 0, i32 %25
	%27 = load i32, i32* @cnt
	store i32 %27, i32* %26
	%28 = load i32, i32* @cnt
	%29 = add i32 %28, 1
	store i32 %29, i32* @cnt
	ret void
}
...
b8:
	...
	store i32 %17, i32* %16
	%18 = alloca i32
	%19 = call i32 @quick_read()
	store i32 %19, i32* %18
	%20 = load i32, i32* %16
	%21 = load i32, i32* %18
	%22 = call i32 @same(i32 %20, i32 %21)
...
b10:
	...
	%29 = load i32, i32* %25
	%30 = load i32, i32* %27
	call void @add_edge(i32 %29, i32 %30)
	br label %b9
}
